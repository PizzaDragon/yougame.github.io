...
class SchoolGoodPart5 extends GameScreen {
    ...
    public draw(ctx: CanvasRenderingContext2D) {
        ...
        this.writeTextToCanvas(ctx, "Kees: Ik verdien dit soort behandeling niet van een kreng zoals jou en ik ga jou eens een lesje leren.", this.canvas.width/2, this.canvas.height - 50);
