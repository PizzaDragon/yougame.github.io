...
class SchoolGoodPart2 extends GameScreen {
    ...
    public draw(ctx: CanvasRenderingContext2D) {
        ...
        this.writeTextToCanvas(ctx, "Na een lange schooldag met hard werken, naar de muur staren en", this.canvas.width/2, this.canvas.height - 90);
        this.writeTextToCanvas(ctx, "niet zeker weten wat 'prend du temps' betekent, lopen jullie naar huis.", this.canvas.width/2, this.canvas.height - 50);
