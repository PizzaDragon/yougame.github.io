...
class SchoolPartyFirstDialogue extends GameScreen {
    ...
    public draw(ctx: CanvasRenderingContext2D) {
        ...
        this.writeTextToCanvas(ctx, "*Je staat te dansen met een jongen en hij gaat tegen je praten*", this.canvas.width / 2, this.canvas.height/2-20, 45)
        this.writeTextToCanvas(ctx, "*Hij stelt zich voor als Kees Meerschal, leunt naar je toe en vraagt je snapchat*", this.canvas.width / 2, this.canvas.height/2 + 20, 45);
